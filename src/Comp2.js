...
function Comp2() {
    const [count, setCount] = useState(0); //первое значение названия стейта второй метод его установки
    const [comment, setComment] = useState([]); //первое значение названия стейта второй метод его установки
